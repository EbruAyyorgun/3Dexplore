...
#fig2.add_trace(go.Scatter3d(
#    name="unselected", x=df['206674_at'], y=df['221923_s_at'], z=df['204039_at'], customdata=df_type_copy, hovertemplate="Type: %{customdata}", marker=dict(color="red")))
#fig2.add_trace(go.Scatter3d(
#    name="selected", x=df['206674_at'], y=df['221923_s_at'], z=df['204039_at'], customdata=df_type_copy, hovertemplate="Type: %{customdata}", marker=dict(color="red")))
